    ...
    def build_header(self):
        ...
        for col in self.grid_columns:
            header_cell = ft.Container(
                col=col.get("col", 1),
                content=ft.Row([
                    ft.Text(col["label"], size=12, weight=ft.FontWeight.BOLD, color=current_theme.secondary),
            ...
            for i, item in enumerate(page_data):
                ...
                for col in self.grid_columns:
                    ...
                    if "render" in col:
                        ...
                        cell_content = ft.Text(str(cell_val), size=13, color=current_theme.text_main)
