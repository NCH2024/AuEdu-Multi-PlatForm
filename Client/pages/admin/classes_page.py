...
class ClassesPage(ft.Container):
    ...
    def __init__(self, page: ft.Page):
        ...
        self.table_container = ft.Container(
            content=ft.Column([
                ft.Row([self.search_field, self.dept_filter, self.semester_filter],
    ...
    async def load_depts(self):
        ...
        try:
            ...
            show_top_notification(self.app_page, f"Lỗi tải Khoa: {e}", ft.Colors.RED)
    ...
    async def load_semesters(self):
        ...
        try:
            ...
            show_top_notification(self.app_page, f"Lỗi tải Học kỳ: {e}", ft.Colors.RED)
    ...
    async def load_data(self):
        ...
        try:
            ...
            show_top_notification(self.app_page, f"Lỗi tải Lớp: {e}", ft.Colors.RED)
    ...
    async def _save_data_async(self):
        ...
        try:
            ...
            show_top_notification(self.app_page, f"Lỗi lưu dữ liệu: {e}", ft.Colors.RED)
